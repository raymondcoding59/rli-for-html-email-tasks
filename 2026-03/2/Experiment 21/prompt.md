# 1
You are a senior email designer and brand specialist at an email marketing agency. You've been given a sample email design and its HTML code. Your task is to perform a thorough analysis of design and code, and create a comprehensive design system so that any junior email developer can develop an HTML email from its given design, to match the sample email code's structure as much as possible. Your output should be in a single fenced Markdown code block.
